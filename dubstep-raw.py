...
class Dubstep( Remixer ):
    ...
    def compileSection( self, j, section ):
        """
    ...
    def remix( self ):
        ...
        try:
            ...
            for i, section in enumerate( self.sections ):
                ...
                a = self.compileSection( i, section )
                self.partialEncode( a, False )
            ...
            print_exception(exc_type, exc_value, exc_traceback,limit=5, file=sys.stderr)
